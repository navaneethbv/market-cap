...
test("applyTradeToQuote handles zero prevClose and zero low", () => {
  const updated = applyTradeToQuote(
    {
      symbol: "AAPL",
      price: 100,
      change: 0,
  ...
  assert.equal(updated.changePercent, 0);
  assert.equal(updated.low, 110);
});
