...
test("classifyNewsSentiment handles null/undefined headline or summary", () => {
  assert.equal(
    classifyNewsSentiment({ headline: undefined, summary: undefined }),
    "unavailable"
  );
  assert.equal(
    classifyNewsSentiment({ headline: "Rally", summary: undefined }),
    "bullish"
  );
  assert.equal(
    classifyNewsSentiment({ headline: undefined, summary: "Fall" }),
    "bearish"
  );
});
