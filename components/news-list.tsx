...
const SENTIMENT_LABELS: Record<Exclude<NewsSentiment, "all">, string> = {
  bullish: "Bullish",
  bearish: "Bearish",
  neutral: "Neutral",
...
const SENTIMENT_CLASSES: Record<Exclude<NewsSentiment, "all">, string> = {
  bullish: "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-300",
  bearish: "border-red-200 bg-red-50 text-red-700 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300",
  ...
  return (
    <div className="divide-y overflow-hidden rounded-2xl border bg-card">
      {visibleArticles.map((article) => {
        const sentiment = classifyNewsSentiment(article);
          ...
          >
            ...
            <div className="min-w-0">
              <div className="mb-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs font-medium text-muted-foreground">
                ...
                <Badge variant="outline" className={SENTIMENT_CLASSES[sentiment]}>
