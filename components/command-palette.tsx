...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: "nav-screen", title: "Stock Screener", subtitle: "Filter by sector, cap & valuation", icon: Filter, href: "/screener", category: "Tools" },
  { id: "nav-movers", title: "Market Movers", subtitle: "Top gainers, losers & baskets", icon: Flame, href: "/movers", category: "Navigation" },
  { id: "nav-compare", title: "Compare Stocks", subtitle: "Side-by-side performance & matrix", icon: TrendingUp, href: "/compare", category: "Tools" },
